...
function nullFunc_ddddddd(x) { err("Invalid function pointer called with signature 'ddddddd'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)");  err("Build with ASSERTIONS=2 for more info.");abort(x) }

function nullFunc_dddddddd(x) { err("Invalid function pointer called with signature 'dddddddd'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)");  err("Build with ASSERTIONS=2 for more info.");abort(x) }
...
function nullFunc_didddddd(x) { err("Invalid function pointer called with signature 'didddddd'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)");  err("Build with ASSERTIONS=2 for more info.");abort(x) }

function nullFunc_diddddddd(x) { err("Invalid function pointer called with signature 'diddddddd'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)");  err("Build with ASSERTIONS=2 for more info.");abort(x) }
...
var asmLibraryArg = {
  ...
  "nullFunc_ddddd": nullFunc_ddddd,
  "nullFunc_dddddd": nullFunc_dddddd,
  "nullFunc_ddddddd": nullFunc_ddddddd,
  "nullFunc_dddddddd": nullFunc_dddddddd,
  "nullFunc_di": nullFunc_di,
  "nullFunc_did": nullFunc_did,
  "nullFunc_didd": nullFunc_didd,
  "nullFunc_diddd": nullFunc_diddd,
  "nullFunc_didddd": nullFunc_didddd,
  "nullFunc_diddddd": nullFunc_diddddd,
  "nullFunc_didddddd": nullFunc_didddddd,
  "nullFunc_diddddddd": nullFunc_diddddddd,
